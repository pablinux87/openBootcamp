 ...
 */
import * as mat from "./modules/controller.js";
import chalk from "chalk";

const log = console.log;
const multi = mat.multi(1, 2);
const sum = mat.suma(4, 5);

log(chalk.red.bold(multi));
log(chalk.bgGreen.blueBright.bold(`        ${sum}        `));

log(chalk.green("Ultimo clg color green!!"));
