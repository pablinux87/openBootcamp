...
const nombre = "Pablo";
const apellido = "Ratero";
const yo = { nombre, apellido };

sessionStorage.setItem("misDatosSesion", JSON.stringify(yo));
localStorage.setItem("misDatosLocalstorage", JSON.stringify(yo));
document.cookie = "misDatosCookies=" + JSON.stringify(yo) + "expires=120";
